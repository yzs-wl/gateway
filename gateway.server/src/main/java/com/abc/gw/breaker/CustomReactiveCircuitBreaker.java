...
public class CustomReactiveCircuitBreaker implements ReactiveCircuitBreaker {
	...
	protected Tuple2<CircuitBreaker, TimeLimiter> buildCircuitBreakerAndTimeLimiter() {
		final io.vavr.collection.Map<String, String> tags = io.vavr.collection.HashMap.of("group", this.groupName);
